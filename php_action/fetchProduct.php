...
$sql = "SELECT product.product_id, product.product_name, product.product_image,product.categories_id, 
			product.quantity, product.rate, product.active, product.product_status, 
 		categories.categories_name FROM product 
		INNER JOIN categories ON product.categories_id = categories.categories_id  
		WHERE product.product_status = 1 AND product.quantity>0";
